...
Scaffold-DbContext "Server=(localdb)\MSSQLLocalDB;Database=AnimeDatabase;Trusted_Connection=True;Encrypt=False" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -Context AnimeDbContext -Tables Directors,Studios,Genres,Animes,Anime_Genres -DataAnnotations -Force
